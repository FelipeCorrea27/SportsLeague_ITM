...
public class MatchLineupController : ControllerBase
{
        ...
        int matchId, CreateMatchLineupDto dto)
    {
        try
        {
            ...
            // Obtenemos con detalles para mapear PlayerName y TeamName
            var lineupWithDetails = await _lineupService.GetLineupByMatchAsync(matchId);
            var createdEntry = lineupWithDetails.FirstOrDefault(l => l.Id == created.Id);

            return CreatedAtAction(nameof(GetLineup), new { matchId },
